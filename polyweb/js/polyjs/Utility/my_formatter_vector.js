...
formatters["formatRegionRec"] = formatRegionRec;
formatters["formatTransmission"] = formatTransmission;
...
function formatPolywebScoreDetailProject(value) {
	...
	for (i=0;i<lValues.length;i++) {
		...
		var new_value = '';
		if (this_value == '') {}
		else if (this_value >= 10) { new_value = this_value+" <img  width=16 height=16 src='/icons/Polyicons/difficulty_2_1.png'>"; }
		else if (this_value >= 7)  { new_value =  this_value+" <img  width=16 height=16 src='/icons/Polyicons/difficulty_1.png'>"; }
		else if (this_value >= 5)  { new_value = this_value+" <img  width=16 height=16 src='/icons/Polyicons/difficulty_0.png'>"; }
		else { new_value = '.'; }
		if (i > 0) { res += '<br>'; }
		res += new_value;
	}
...
function formatDejavuBadges(value, with_descrition) {
	if (value =="-") { return "<span class=\"glyphicon glyphicon-eye-close\"></span>"; }
	var lTmp1 = value.split("\n");
	var lTmp2 = lTmp1[0].split('/');
	var nb_proj = parseInt(lTmp2[0]);
	var nb_pat = parseInt(lTmp2[1]);
	var color;
	if (parseInt(nb_proj) > 50)      { color = ''; }
	else if (parseInt(nb_proj) > 30) { color = " style=\"background-color:#449D44\"";; }
	else if (parseInt(nb_proj) > 10) { color = " style=\"background-color:#FEA500\""; }
	else 				   { color = " style=\"background-color:#FD5936\""; }
	if (with_descrition == 1) { return "<span class=\"badge\"" + color + ">DejaVu: " + nb_proj + " / " + nb_pat + "</span>"; }
	return "<span class=\"badge\"" + color + ">" + nb_proj + " / " + nb_pat + "</span>";
}
...
function formatProteinName (value){
	...
	var eurl = '<a href="http://www.ensembl.org/Homo_sapiens/Transcript/ProteinSummary?db=core;p='
	  ...
	  + '" target="_blank">'
	  + tab[0] + '</a>';
	if (tab[1]) { tab[1] = tab[1].replace(/;/g, "<br>"); }  
...
function formatChild2(val) {
	if (val == "C21")  return "<center><img src='/icons/Polyicons/baby-girl-s.png'></center>";
	if (val == "C22")  return "<center><img src='/icons/Polyicons/baby-girl-d.png'></center>";
	if (val == "C11")  return "<center><img src='/icons/Polyicons/baby-boy-s.png'></center>";
	if (val == "C12")  return "<center><img src='/icons/Polyicons/baby-boy-d.png'></center>";
	if (val == "F1")  return "<center><img src='/icons/Polyicons/male-s.png'></center>";
	if (val == "F2")  return "<center><img src='/icons/Polyicons/male-d.png'></center>";
	if (val == "M1")  return "<center><img src='/icons/Polyicons/female-s.png'></center>";
	if (val == "M2")  return "<center><img src='/icons/Polyicons/female-d.png'></center>";
	if (val == "F")  return "<center><img src='/icons/Polyicons/male.png'></center>";
	if (val == "M")  return "<center><img src='/icons/Polyicons/female.png'></center>";
	if (val == "1")  return "<center><img src='/icons/Polyicons/male.png'></center>";
	if (val == "2")  return "<center><img src='/icons/Polyicons/female.png'></center>";
...
function formatInclude(value){
	...
	switch(value){
		...
		case 2:{
			return "<img src='/icons/Polyicons/trashcan-full-icon.png'>";
		}
		case -1:{
...
function formatTransmission (value) {
	if (value == 'recessive') { return "<center>Recessive</center>"; }
	else if (value == 'Both') { return "<center><img src='/icons/Polyicons/male.png'>" + "  " + "<img src='/icons/Polyicons/female.png'></center>"; }
	else if (value == 'Father') { return "<center><img src='/icons/Polyicons/male.png'></center>"; }
	else if (value == 'Mother') { return "<center><img src='/icons/Polyicons/female.png'></center>"; }
	else if (value == 'denovo') { return "<center>Denovo</center>"; }
	else if (value == 'strict_denovo') { return "<center>Strict Denovo</center>"; }
	else if (value == 'Mosaic (from father)') { return "<center>Mosaic " + "<img src='/icons/Polyicons/male.png'></center>"; }
	else if (value == 'Mosaic (from mother)') { return "<center>Mosaic " + "<img src='/icons/Polyicons/female.png'></center>"; }
	return value;
}
