...
var url_path = "/cgi-bin/polymorphism-cgi/";
   ...
   function onSearchAll (input,name){
               ...
               grid.filter({complexQuery: "name:"+string+"OR description:"+string+"OR users:"+string+"OR patient_name:"+string+"OR capture_name:"+string});
        };
...
var url_cache_patient = url_path+json_out+"/fast_patients_json.pl";
...
var url_patients = url_path+"/validation_variation/fast_patients_json.pl";
...
var url_coverage_overview_new = url_path+"validation_variation/table_image_updated.pl";

var url_coverage_json = url_path+"/polydiag_old/coverage_json.pl";  
var url_coverage_overview = url_path+"/polydiag_old/table_image.pl";
...
var url_cnv_dude = url_path+"/validation_variation/table_dude.pl";
var url_problem = url_path+"/problem_capture/report_problem.pl";
/* change before holydays 
var url_polydiag = url_path+"/polydiag_old/patient_report.pl";
var url_report_patient =  url_path+"/polydiag_old/patient_report.pl";
var url_report_patient_cache =  url_path+"/polydiag_old/patient_report.pl";
var url_coverage = url_path+"/polydiag_old/coverage_exons.pl";
var url_cnv_overview = url_path+"/polydiag_old/table_images_cnv.pl";
*/
...
var url_report_patient_cache =  url_path+"/validation_variation/patient_report.pl";
var url_polydiag = url_path+"/validation_variation/patient_report.pl";
var url_cnv_overview = url_path+"/validation_variation/table_images_cnv.pl";
...
var url_dejavu = "polydejavu/dejavu.html";
var url_dude = url_path+"/validation_variation/dude_editor.pl";
var url_low =  url_path+"/validation_variation/get_low_coverage_exons.pl";
// mes tests
