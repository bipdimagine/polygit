...
use Config::Std; 
use Data::Dumper;
use lib "/data-isilon/public-data/repository/HG19/prediction_matrix/110/ensembl-variation/modules";
use lib "/data-isilon/public-data/repository/HG19/prediction_matrix/110//ensembl/modules";
use lib "/data-isilon/public-data/repository/HG19/prediction_matrix/110/bioperl-live/";
use lib "/data-isilon/public-data/repository/HG19/prediction_matrix/110/ensembl-variation/modules";
...
sub getConfig{
	my ($self) = @_;
	read_config "$Bin/ensembl.cfg" => my %config;
	$self->{config} = \%config;
