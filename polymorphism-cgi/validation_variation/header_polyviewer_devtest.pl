...
#		print "Polyviewer - <i>Defidiag</i>";
#	}
#	else {
#		print "Polyviewer";
#	}
#	if ($project->isGenome){
#		print "<BR>WGS<BR>$ver1"; 
#	}
#	elsif ($project->isExome){
#		print "<BR>WES<BR><i>$ver1</i>"; 
#	}
#	else{
#		print "<BR>Panel<BR><i>$ver1</i>"; 
#	}
#	print end_button();
#	print  $cgi->end_div;
#	print "</td>";
...
#	print $cgi->start_div({class=>"btn-group btn-group-xs", role=>"group",style=>"background-color:$ccolor;padding-left:8px;padding-right:8px;"});
#	print start_button({class=>"btn btn-$h2",style=>$style_b.";font-size:12px;border-width:0px;background-color:$ccolor".";color:white"});
#	print $project->name()."<br>Samples: ".scalar(@{$project->getPatients})."<BR>$day-$month-$year";
#	print end_button();
#	print  $cgi->end_div;
#	print "</td>";
