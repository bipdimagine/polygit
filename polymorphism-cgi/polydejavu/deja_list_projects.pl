...
$out .= qq{<table class='table table-sm bootstrap-table-projects' data-filter-control='true' data-id-field="name" data-sort-name="name" data-sort-order="desc" data-toggle="table"  data-cache="false" data-pagination-loop="false" data-pagination-v-align="top" data-pagination-pre-text="Previous" data-pagination-next-text="Next" data-toggle="true" data-pagination="true" data-show-page-list="false" data-smart-display="true" data-page-size="10" data-page-list="[]" id='table_projects_found' class='table table-striped' style='font-size:09px;'>};
$out .= "<thead>";
$out .= $cgi->start_Tr({style=>"background-color:#E9DEFF;font-size:9px;"});
#$out .= qq{<th data-field="found"></th>};
#$out .= qq{<th data-field="status" data-filter-control="input">Status</th>};
$out .= qq{<th data-field="select"></th>};
$out .= qq{<th data-field="name" data-filter-control="input" data-filter-control-placeholder="">Name</th>};
...
#	}
	...
	if ($status =~ /Excluded/) {
		$h_p->{$project_name} .=  $cgi->td("<center><div><input type='checkbox' id='b_sel_$project_name' name='b_sel_$project_name' checked disabled/><label for='b_sel_$project_name'></label></div></center>");
	}
	else {
		$h_p->{$project_name} .=  $cgi->td("<center><div><input onClick=\"select_one_project('$project_name')\" type='checkbox' id='b_sel_$project_name' name='b_sel_$project_name' checked/><label for='b_sel_$project_name'></label></div></center>");
	}
