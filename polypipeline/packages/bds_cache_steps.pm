...
sub html_rna_junctions {
	...
	$cmd .= " | perl $Bin/../polymorphism-cgi/rnaseq/rna_junctions_patient.pl project=$projectName patient=$patientName dejavu=10 dejavu_percent=100 min_score=10 1>$fileout";
