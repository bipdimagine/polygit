...
sub flushObjectVariantCache {
	...
	elsif  ($ref ne 'GenBoLargeInsertionCache' && $ref ne 'GenBoVariationCache' &&  $ref ne 'GenBoInversionCache' &&  $ref ne 'GenBoInsertionCache' && $ref ne 'GenBoDeletionCache' && $ref ne 'GenBoLargeDuplicationCache' && $ref ne 'GenBoLargeDeletionCache' && $ref ne 'GenBoMeiCache') {
